//
//  MinutesRemainingViewController.h
//  Nurse App
//
...
@interface MinutesRemainingViewController : UIViewController

@property (strong, nonatomic) IBOutlet UIScrollView *scrollView;
@property (strong, nonatomic) NSString *pageTitle;
@property(nonatomic,strong)IBOutlet UITableView * minutesremainigTableview;
